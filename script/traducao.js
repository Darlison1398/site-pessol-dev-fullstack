...
const translations = {
    en: {
        ...
        start: "Welcome to my portfolio, my name is Darlison Silva and I am 25 years old. I have 3 years and 2 months of experience with technology, developing skills in various areas. I have comprehensive knowledge in web development, both front-end and back-end. Additionally, I am proficient in databases, web design and code versioning. I am also familiar with agile methodologies and have experience in customer support. My main goal is to become a Software Engineer, and I am constantly improving my skills and looking for new opportunities to grow professionally",
    ...
    es: {
        ...
        start: "Bienvenidos a mi portafolio, mi nombre es Darlison Silva y tengo 25 años. Cuento con 2 años y 9 meses de experiencia con tecnología, desarrollando habilidades en diversas áreas. Tengo amplios conocimientos en desarrollo web, tanto front-end como back-end. Además, soy competente en bases de datos, diseño web y control de versiones de código. También estoy familiarizado con metodologías ágiles y tengo experiencia en atención al cliente. Mi principal objetivo es convertirme en Ingeniero de Software, y estoy constantemente mejorando mis habilidades y buscando nuevas oportunidades para crecer profesionalmente.",
    ...
    pt: {
        ...
        start: "Bem-vindo ao meu portfólio, meu nome é Darlison Silva e tenho 25 anos. Possuo 3 anos e 2 meses de experiência com tecnologia, desenvolvendo habilidades em várias áreas. Tenho um conhecimento abrangente em desenvolvimento web, tanto no front-end quanto no back-end. Além disso, sou proficiente em banco de dados, design web e versionamento de códigos. Também estou familiarizado com metodologias ágeis e tenho experiência em suporte ao cliente. Meu principal objetivo é me tornar um Engenheiro de Software, e estou constantemente aprimorando minhas habilidades e buscando novas oportunidades para crescer profissionalmente.",
